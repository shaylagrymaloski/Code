...
public class EncryptDecryptText {
    public static void main(String args[]) {
        String result = null;
        String infileName = "themessage";
        String outfileName = "uvfnsttohf";
     ...
     */
    public static void encryptStream(Scanner input, PrintStream output,Cipher c) {
        while (input.hasNext()) {
     ...
     */
    public static void decryptStream(Scanner input, PrintStream output,Cipher c) {
        while (input.hasNext()) {
            String line = input.nextLine();
